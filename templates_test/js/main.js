...
function preload() {
  ...
  this.load.spritesheet('basictiles', staticUrl+'assets/basictiles.png', { frameWidth: 48, frameHeight: 48 });
  // load images
  this.load.atlas('hero', staticUrl+'assets/hero.png', staticUrl+'assets/hero.json');
  this.load.atlas('hit', staticUrl+ 'assets/hit.png', staticUrl+'assets/hit.json');
  this.load.atlas('sorcerer', staticUrl+'assets/sorcerer.png', staticUrl+'assets/sorcerer.json');
  this.load.atlas('sorcery', staticUrl+'assets/sorcery.png', staticUrl+'assets/sorcery.json');
  this.load.atlas('fire', staticUrl+'assets/fire.png', staticUrl+'assets/fire.json');
